...
export const studyVideoSessions = mysqlTable("studyVideoSessions", {
  ...
  lessonTitle: varchar("lessonTitle", { length: 220 }),
  subject: mysqlEnum("subject", ["arabic", "history", "english", "programming_ai", "german", "other"]).default("other").notNull(),
  sourceMode: mysqlEnum("sourceMode", ["embedded", "external"]).default("embedded").notNull(),
  manualProgress: mysqlEnum("manualProgress", ["started", "middle", "finished", "reviewed"]).default("started").notNull(),
  timerRunning: boolean("timerRunning").default(false).notNull(),
